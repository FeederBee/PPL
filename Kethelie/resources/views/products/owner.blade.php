            ...
            <form action="{{ route('products.store') }}" class="row g-2 " method="POST" enctype="multipart/form-data">
                ...
                <div class="text-start mt-3">
                  ...
                  <div class="col-md-6 text-start mt-3">
                    ...
                    <input type="text" name="nama" class="form-control border border-2 border-success @error('nama')is-invalid @enderror" id="inputnama" placeholder="Nama Anda"/>
                    @error('nama')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="row g-2">
                    <div class="col text-start mt-3">
                      ...
                      <input type="text" name="harga" class="form-control border border-2 border-success @error('harga')is-invalid @enderror" />
                      @error('harga')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col text-start mt-3">
                      ...
                      <input type="text" name="stok" class="form-control border border-2 border-success @error('stok')is-invalid @enderror" id="inputStok" />
                      @error('stok')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
              ...
              @method('PUT')
                  ...
                  <div class="row g-2">
                    <div class="col text-start mt-3">
                      ...
                      <input type="text" name="harga" value="{{ $product->harga }}" class="form-control border border-2 border-success  @error('harga')is-invalid @enderror" />
                      @error('harga')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col text-start mt-3">
                      ...
                      <input type="text" name="stok" value="{{ $product->stok }}"  class="form-control border border-2 border-success  @error('stok')is-invalid @enderror" id="inputStok" />
                      @error('stok')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
